                    ...
                    <div class="iq-card-body">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td><a href="<?= site_url('advertiser_dashboard/add_payment/') ?>" class="btn btn-danger btn-sm">Cancel</a> <a href="<?= ($payment_option == 'paymt_gate') ? site_url('advertiser_dashboard/advertiser_online_gateway_payment/') : site_url('advertiser_dashboard/advertiser_online_coupon_payment/') ?>" class="btn btn-success btn-sm">Pay</a> </td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
