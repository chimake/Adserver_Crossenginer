            ...
            <div class="col-sm-6 align-self-center">
                <div class="sign-in-from">
                    ...
                    <span class="text-center">
                        <h1 class="mb-0">Forgotten Password</h1>
                        <p>Password recovery link will be sent to your registered Email,Please check inbox or spam for the recovery mail.Thank you</p>
                    </span>
                    ...
                    <form class="mt-4" method="post" action="<?php echo site_url('page/forget_password'); ?>">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Email address</label>
                            <input type="email" class="form-control mb-0" id="inputEmail1" name="email" placeholder="Enter email" value="<?php echo set_value("email"); ?>">
                        </div>

                        <div class="d-inline-block w-100">
                            <button type="submit" class="btn btn-primary float-right" name='submit'>Send Me</button>
                        </div>
                        <div class="sign-info">
